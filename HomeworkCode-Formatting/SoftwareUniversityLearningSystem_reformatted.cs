namespace Problem4.SoftwareUniversityLearningSystem
{
    ...
    class OnsiteStudent : CurrentStudent
    {
        ...
        public OnsiteStudent(string firstName, string lastName, int age, long studentNum, double averageGrade, string currentCourse, int numberOfVisits)
    ...
    class DropoutStudent : Student
    {
        ...
        public DropoutStudent(string firstName, string lastName, int age, long studentNum, double averageGrade, string dropoutReason)
            : base(firstName, lastName, age, studentNum, averageGrade)
        {
    ...
    class SoftwareUniversityLearningSystem
    {
        static void Main()
        {
            ...
            peopleList.Where(p => p is CurrentStudent).
                OrderBy(p => ((CurrentStudent)p).AverageGrade).
                Reverse().ToList().
